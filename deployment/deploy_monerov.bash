...
cd ~
git clone https://github.com/miltonf/monerov-pool.git  # Change this depending on how the deployment goes.
cd /usr/src/gtest
sudo cmake .
sudo make
...
cd /usr/local/src
sudo git clone https://github.com/monerov/monerov.git
cd monerov
